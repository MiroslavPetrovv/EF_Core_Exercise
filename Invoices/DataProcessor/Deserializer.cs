namespace Invoices.DataProcessor
{
    ...
    public class Deserializer
    {
        ...
        public static string ImportClients(InvoicesContext context, string xmlString)
        {
            ...
            ImportClientDto[] deserializeClients =
                xmlHelper.Deserialize<ImportClientDto[]>(xmlString, xmlRoot);
            foreach (ImportClientDto clientDto in deserializeClients)
            {
        ...
        public static string ImportInvoices(InvoicesContext context, string jsonString)
        {
            ...
            foreach (ImportInvoiceDto invoiceDto in deserializedInvoices)
            {
                ...
                bool isIssueDateValid=DateTime
                    .TryParse(invoiceDto.IssueDate,CultureInfo.InvariantCulture,
                    DateTimeStyles.None,out DateTime issueDate);

                bool isDueDateValid = DateTime.
                    TryParse(invoiceDto.DueDate,CultureInfo.InvariantCulture,
        ...
        public static string ImportProducts(InvoicesContext context, string jsonString)
        {
            ...
            ImportProductDto[] importProductDto =
                JsonConvert.DeserializeObject<ImportProductDto[]>(jsonString)!;
            foreach (ImportProductDto productDto in importProductDto)
            {
